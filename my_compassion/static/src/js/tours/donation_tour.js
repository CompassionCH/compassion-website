odoo.define("compassion_website.donation_tour", function (require) {
    ...
    tour.register(
        "single_one_time_fund_with_custom_amount",
        {
            test: true,
            url: "/my2/gifts",
        },
    ...
    tour.register(
        "single_monthly_fund_with_suggested_amount",
        {
            test: true,
            url: "/my2/gifts",
        },
    ...
    tour.register(
        "single_monthly_fund_with_custom_amount",
        {
            test: true,
            url: "/my2/gifts",
        },
        ...
        [
            {
                ...
                run: function () {
                    console.log("Item found, ready to delete.");
                },
            },
            {
    ...
    tour.register(
        ...
        [
            ...
            },
            {
                ...
                run: function () {
                    console.log("Item successfully updated to 75.");
                },
            },
        ]
    );
    ...
    tour.register(
        "single_one_time_fund_through_modal",
        {
            test: true,
            url: "/my2/gift-package",
        },
    ...
    tour.register(
        "try_to_submit_empty_custom_amount",
        {
            test: true,
            url: "/my2/gifts",
        },
