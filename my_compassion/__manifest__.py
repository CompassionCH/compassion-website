...
# pylint: disable=C8101
{
    ...
    "data": [
        ...
        "data/my2_details_reminder_email.xml",
        ...
        "templates/pages/my2_new_sponsorship_wizard/progress_bar.xml",
        "templates/pages/my2_new_sponsorship_wizard/sponsorship_plus.xml",
        "templates/pages/my2_new_sponsorship_wizard/standard_step.xml",
        "templates/pages/my2_new_sponsorship_wizard/wap_step.xml",
        "templates/pages/my2_new_sponsorship_wizard/logged_in_steps.xml",
        "templates/pages/my2_new_sponsorship_wizard/my2_new_sponsorship_wizard.xml",
        "templates/pages/my2_new_sponsorship_wizard/thank_you_page.xml",
        "templates/pages/my2_new_sponsorship_payment.xml",
        "templates/pages/my2_new_sponsorship_details.xml",
