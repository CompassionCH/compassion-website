...
class MyCompassionCorrespondenceController(http.Controller):
    @http.route(
        "/my2/children/<int:child_id>/letters",
        type="http",
        auth="user",
        website=True,
        sitemap=False,
    ...
    @http.route(
        "/my2/children/<int:child_id>/letter/new",
        type="http",
        auth="user",
        website=True,
        sitemap=False,
    ...
    def my2_render_new_letter_page(self, child_id, **kwargs):
        ...
        templates = (
            ...
            # Sort the templates alphabetically, placing "Christmas" templates
            # at the beginning "0" is special sorting key because it comes before
            # any letter in ASCII order.
        ...
        breadcrumbs = [
            ...
            {
                "name": "New Letter",
                "url": "/my2/children/" + str(child_id) + "/letter/new",
                "active": True,
            },
        ]
