    ...
    def render_donation_page(self, type="fund", **kwargs):
        ...
        if type == "gift":
            page_content = {
                ...
                "description": "Send a gift to your sponsored child and Compassion staff from their local  church will support them in purchasing something they really need.",
                "banner_title": "Gift of compassion",
                "banner_text": "Every child deserves a secure home, safe water and medicine to keep them healthy.  That’s why when poverty places a child in critical need, we take action.",
            ...
            page_content = {
                ...
                "description": "Make a difference and bring hope to children living in extreme poverty. ",
                "banner_title": "Give to your sponsored children",
                "banner_text": "Send a gift to your sponsored child. Compassion staff from their local church will support them in purchasing something they really need. ",
                "banner_btn_text": "Send a gift",
