odoo.define("website_event_compassion.event_registration_form_page", function (require) {
    "use strict";
    ...
    publicWidget.registry.EventRegistrationForm = publicWidget.Widget.extend({
        ...
        setup_default_values: function () {
            ...
            const event_id = form_values.event_id;
            if (event_id) $("select[name='event_id']").val(event_id);
            const select_fields = ["partner_title"];
